...
class AddEditAddressActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mAddressDetails != null){
            if (mAddressDetails!!.id.isNotEmpty()){
                tv_add_edit_address_title.text = resources.getString(R.string.title_edit_address)
                btn_submit_address.text = resources.getString(R.string.btn_lbl_update)

                et_full_name.setText(mAddressDetails?.fullName)
                et_phone_number.setText(mAddressDetails?.phoneNumber)
    ...
    fun addUpdateAddressSuccess(){
        ...
        val notifySuccessMessage = if (mAddressDetails != null && mAddressDetails!!.id.isNotEmpty()){
            ...
            resources.getString(R.string.your_address_added_successfully)
        }
